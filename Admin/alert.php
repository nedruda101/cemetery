              ...
              <div class="col-sm-12 col-md-12">
                <div class="bg-white p-4 h-100 rounded">
                  <div class="title-header bg-white sticky-top p-3 d-flex">
                    ...
                    <button class="btn btn-primary add-customer d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#alert-customer">
        ...
        <div class="modal-content">
            ...
            <form action="send_alert.php" method="post">
                ...
                <div class="modal-footer">
                    <button type="submit" name="send-alert" class="btn btn-primary">Send Alert</button>
